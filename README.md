...
5. **Open the pull request.** Ask Claude: *"Open a pull request for this branch. Select mate-academy/git-playground-task3 as a base"* It reads your commits and writes the title and description.
